declare module "data-navigator" {
  ...
  type Semantics =
    | ((RenderObject?, DatumObject?) => SemanticsObject)
    | SemanticsObject;
  type Dimensions =
    | ((RenderObject?, DatumObject?) => DimensionsObject)
    | DimensionsObject;
  type Attributes =
    | ((RenderObject?, DatumObject?) => AttributesObject)
    | AttributesObject;
